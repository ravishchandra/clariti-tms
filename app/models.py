...
class FileFormatType(str, enum.Enum):
    i18next = "i18next"
    icu = "icu"
...
class PluralConvention(str, enum.Enum):
    icu = "icu"
...
class StringType(str, enum.Enum):
    button = "button"
    title = "title"
    label = "label"
...
sa_file_format_type = enum.Enum(
    "FileFormatType", {e.value: e.value for e in FileFormatType}
)
sa_plural_convention = enum.Enum(
    "PluralConvention", {e.value: e.value for e in PluralConvention}
)
...
sa_translation_status = enum.Enum(
    "TranslationStatus", {e.value: e.value for e in TranslationStatus}
)
...
class User(Base):
    ...
    assigned_locales: Mapped[list[str]] = mapped_column(
    ...
    glossary_terms_created: Mapped[list[GlossaryTerm]] = relationship(
        "GlossaryTerm", back_populates="created_by_user"
    )
    screenshots_uploaded: Mapped[list[Screenshot]] = relationship(
        "Screenshot", back_populates="uploaded_by_user"
    )
    import_jobs: Mapped[list[ImportJob]] = relationship(
        "ImportJob", back_populates="uploaded_by_user"
    )
...
class Project(Base):
    ...
    import_jobs: Mapped[list[ImportJob]] = relationship(
        "ImportJob", back_populates="project"
    )
...
class Repository(Base):
    ...
    plural_convention: Mapped[str] = mapped_column(
        String(50), nullable=False, server_default="icu"
    )
    ...
    contentful_env: Mapped[Optional[str]] = mapped_column(
        Text, nullable=True, server_default="master"
    )
    contentful_token_encrypted: Mapped[Optional[str]] = mapped_column(
        Text, nullable=True
    )
    contentful_webhook_secret_encrypted: Mapped[Optional[str]] = mapped_column(
        Text, nullable=True
    )
    webhook_secret_encrypted: Mapped[Optional[str]] = mapped_column(
        Text, nullable=True
    )
    ...
    keys: Mapped[list[Key]] = relationship(
        "Key", back_populates="repository", cascade="all, delete-orphan"
    )
    translation_batches: Mapped[list[TranslationBatch]] = relationship(
        "TranslationBatch", back_populates="repository"
    )
    translation_memory_entries: Mapped[list[TranslationMemory]] = relationship(
...
class ComponentContext(Base):
    ...
    screen: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    description: Mapped[str] = mapped_column(Text, nullable=False)
    default_risk_class: Mapped[str] = mapped_column(
        Text, nullable=False, server_default="standard"
    )
    default_max_length: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    ...
    repository: Mapped[Repository] = relationship(
        "Repository", back_populates="component_contexts"
    )
...
class LocaleConfig(Base):
    ...
    __table_args__ = (
        UniqueConstraint("project_id", "locale", name="uq_locale_config"),
    )
    ...
    notes: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    is_bootstrapped: Mapped[bool] = mapped_column(
...
class Key(Base):
    __tablename__ = "keys"
    __table_args__ = (
        UniqueConstraint("repository_id", "key", name="uq_key_repository"),
    )
    ...
    string_type: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    description: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    component: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    screen: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    ...
    has_structural_tags: Mapped[bool] = mapped_column(
        Boolean, nullable=False, server_default="false"
    )
    icu_shape: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    plural_format: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    ...
    source: Mapped[str] = mapped_column(
        Text, nullable=False, server_default="github"
    )
...
class TranslationBatch(Base):
    ...
    mt_model: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    mt_prompt_version: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    ...
    # Relationships
    repository: Mapped[Repository] = relationship(
        "Repository", back_populates="translation_batches"
    )
    translations: Mapped[list[Translation]] = relationship(
        "Translation", back_populates="batch"
    )
    mt_runs: Mapped[list[MtRun]] = relationship(
        "MtRun", back_populates="batch"
    )
...
class Translation(Base):
    ...
    source_hash_at_translation: Mapped[Optional[str]] = mapped_column(
        Text, nullable=True
    )
    mt_value: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    mt_model: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    mt_prompt_version: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    mt_run_at: Mapped[Optional[datetime]] = mapped_column(
        DateTime(timezone=True), nullable=True
    )
    # QA scores
    back_translation: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    back_translation_similarity: Mapped[Optional[float]] = mapped_column(
        Numeric(5, 4), nullable=True
    )
    qa_naturalness: Mapped[Optional[int]] = mapped_column(SmallInteger, nullable=True)
    qa_consistency: Mapped[Optional[int]] = mapped_column(SmallInteger, nullable=True)
    qa_accuracy: Mapped[Optional[int]] = mapped_column(SmallInteger, nullable=True)
    qa_issue: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    # Review
    reviewer_id: Mapped[Optional[uuid.UUID]] = mapped_column(
        UUID(as_uuid=True), ForeignKey("users.id"), nullable=True
    )
    reviewer_action: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    ...
    batch: Mapped[Optional[TranslationBatch]] = relationship(
        "TranslationBatch", back_populates="translations"
    )
...
class TranslationHistory(Base):
    ...
    prev_value: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    new_value: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    prev_status: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    new_status: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    changed_by: Mapped[Optional[uuid.UUID]] = mapped_column(
        UUID(as_uuid=True), ForeignKey("users.id"), nullable=True
    )
    change_source: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    ...
    translation: Mapped[Translation] = relationship(
        "Translation", back_populates="history"
    )
...
class GlossaryTerm(Base):
    ...
    project: Mapped[Project] = relationship(
        "Project", back_populates="glossary_terms"
    )
...
class TranslationMemory(Base):
    ...
    source_text: Mapped[str] = mapped_column(Text, nullable=False)
    source_embedding: Mapped[Optional[list[float]]] = mapped_column(
        Vector(1536), nullable=True
    )
    locale: Mapped[str] = mapped_column(Text, nullable=False)
    target_text: Mapped[str] = mapped_column(Text, nullable=False)
    context: Mapped[Optional[dict]] = mapped_column(JSONB, nullable=True)
    source_key_id: Mapped[Optional[uuid.UUID]] = mapped_column(
    ...
    # Relationships
    project: Mapped[Project] = relationship(
        "Project", back_populates="translation_memory_entries"
    )
    repository: Mapped[Optional[Repository]] = relationship(
        "Repository", back_populates="translation_memory_entries"
    )
    source_key: Mapped[Optional[Key]] = relationship(
        "Key", back_populates="translation_memory_entries"
    )
...
class Screenshot(Base):
    ...
    highlighted_region: Mapped[Optional[dict]] = mapped_column(JSONB, nullable=True)
...
class ImportJob(Base):
    ...
    export_timestamp: Mapped[Optional[datetime]] = mapped_column(
        DateTime(timezone=True), nullable=True
    )
    dry_run_summary: Mapped[Optional[dict]] = mapped_column(JSONB, nullable=True)
...
class MtRun(Base):
    ...
    validators_passed: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True)
    validator_errors: Mapped[Optional[dict]] = mapped_column(JSONB, nullable=True)
    ...
    # Relationships
    batch: Mapped[Optional[TranslationBatch]] = relationship(
        "TranslationBatch", back_populates="mt_runs"
    )
