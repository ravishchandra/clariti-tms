                  ...
                  >
                    ...
                    <div className="mt-7 pt-6">
                      <a
                        ...
                        className={
                          t.cta.primary
                            ? "inline-flex w-full items-center justify-center gap-2 rounded-md bg-[var(--color-flame)] px-4 py-2.5 text-[13.5px] font-semibold text-[#0a2e2c] shadow-flame transition-all hover:bg-[var(--color-flame-soft)]"
