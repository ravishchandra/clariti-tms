      ...
      <div className="lg:col-span-4">
        <div className="sticky top-20 rounded-xl border border-[var(--color-line-strong)] bg-[var(--color-ink-1)] p-5">
          ...
          <div className="mt-6 flex gap-2">
            <button
              onClick={run}
              className="flex-1 rounded-md bg-[var(--color-flame)] px-4 py-2.5 text-[13.5px] font-semibold text-[#0a2e2c] shadow-flame transition-all hover:bg-[var(--color-flame-soft)] disabled:opacity-50"
