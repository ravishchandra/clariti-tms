...
function Header() {
  // Compact header: this page now lives under the Settings → Data tab, which
  // already renders the page-level "Project & admin" h1 + tab nav, so a second
  // big h1 would double up. Matches the other Settings sub-page headers.
  return (
    <header className="flex flex-col gap-1">
      <h2 className="flex items-center gap-2 text-sm font-semibold tracking-tight text-foreground">
        <FileSpreadsheet className="size-4 text-flame-soft" />
        Export to Excel
      </h2>
  ...
  return (
    <Card>
      ...
      <CardContent className="py-3 text-sm text-app-text-muted">
        No index endpoint yet — generated workbooks save to your browser&apos;s
